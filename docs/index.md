        ...
        <header class="md-typeset">
            <div style="text-align: center; margin: 20px 0;">
                <div style="width: 150px; height: 150px; overflow: hidden; border-radius: 50%; margin: 0 auto;">
                    <img src="assets/lake_blanche.jpg" alt="Thomas" style="width: 175%; height: 175%; object-fit: cover; transform: translate(0%, -22%);">
                </div>
                <!-- <img src="assets/lake_blanche.jpg" alt="Thomas" style="border-radius: 50%; width: 150px; height: 150px; object-fit: cover;"> -->
                <!-- <img src="assets/lake_blanche.jpg" alt="Thomas" style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover; object-position: center;"> -->
                <h1 style="color: var(--md-primary-fg-color);">Thomas Saigre, PhD</h1>
                <a class="md-button" href="mailto:thomas.saigre-tardif@inria.fr"><span class="twemoji"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2024 Fonticons, Inc.--><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4l217.6 163.2c11.4 8.5 27 8.5 38.4 0l217.6-163.2c12.1-9.1 19.2-23.3 19.2-38.4 0-26.5-21.5-48-48-48zM0 176v208c0 35.3 28.7 64 64 64h384c35.3 0 64-28.7 64-64V176L294.4 339.2a63.9 63.9 0 0 1-76.8 0z"/></svg></span></a>
...
<div style="display: flex; gap: 20px; justify-content: center; align-items: center;">
    <div>
        <a href="https://www.inria.fr">
            <img src="assets/logo-inria.svg" alt="inria" style="height: 80px; width: 200px; object-fit: contain;">
        </a>
    </div>
    <div>
        <a href="https://mimesis.inria.fr/">
            <img src="assets/logo-mimesis-white.svg#only-dark" alt="mimesis" style="height: 80px; width: 200px; object-fit: contain;">
            <img src="assets/logo-mimesis.svg#only-light" alt="mimesis" style="height: 80px; width: 200px; object-fit: contain;">
        </a>
    </div>
</div>
